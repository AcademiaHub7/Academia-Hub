...
export const MessagingCenter: React.FC = () => {
  ...
  }, [selectedFolder, fetchFolders, fetchMessages, searchParams]);
  ...
  const handleExportMessages = () => {
    ...
    a.href = url;
    a.download = `messages-${selectedFolder}-${new Date().toISOString().split('T')[0]}.json`;
    a.click();
      ...
      <div className="w-64 bg-white border-r border-gray-200 flex flex-col">
        ...
        <div className="p-4 border-t border-gray-200">
          ...
          <button
            ...
            className="w-full mt-2 px-3 py-2 text-xs text-gray-600 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors"
          >
            ...
            <div className="flex items-center space-x-2">
              <button
                ...
                className={`p-2 transition-colors ${
                  showFilters ? 'text-primary-color' : 'text-gray-400 hover:text-gray-600'
                }`}
              >
          ...
          {showFilters && (
            <div className="bg-gray-50 rounded-lg p-3 mb-3">
              <div className="grid grid-cols-2 gap-2">
                ...
                <select className="text-xs px-2 py-1 border border-gray-300 rounded">
                  <option>Tous expéditeurs</option>
                  <option>Patronats</option>
                  <option>Écoles</option>
                </select>
              </div>
            </div>
          )}
