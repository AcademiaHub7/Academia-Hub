...
export const Router: React.FC = () => {
  ...
  return (
      <Routes>
        ...
        />
        {/* Empty path route to handle direct access to /examtrack */}
        <Route 
          index 
          element={isAuthenticated ? <Navigate to="/dashboard" replace /> : <LandingPage />} 
        />
        ...
        <Route 
          path="patronat/login" 
          element={isAuthenticated ? <Navigate to="/examtrack/dashboard" replace /> : <PatronatLogin />} 
        />
        <Route 
          path="patronat/register" 
          element={isAuthenticated ? <Navigate to="/examtrack/dashboard" replace /> : <RegistrationWizard />} 
        />
        <Route 
          path="school/login" 
          element={isAuthenticated ? <Navigate to="/examtrack/dashboard" replace /> : <SchoolLogin />} 
        />
        
        {/* Unified login route for both patronat and school */}
        <Route 
          path="login" 
          element={isAuthenticated ? <Navigate to="/examtrack/dashboard" replace /> : <LoginForm />} 
        />
