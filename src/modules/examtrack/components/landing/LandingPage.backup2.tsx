            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Plateforme de Gestion des Examens - Ãƒâ€°coles PrivÃƒÂ©es du BÃƒÂ©nin
                </p>
              </div>
            </motion.div>
            <motion.div 
      ...
      <section className="relative py-20 md:py-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          >
            ...
            >
              <span className="text-sm font-medium text-white">Ã¢Å“Â¨ Plateforme Officielle - Version 2.0</span>
            </motion.div>
            ...
            >
              Gestion Scolaire <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-300 to-yellow-500">SimplifiÃƒÂ©e</span>
            </motion.h1>
            ...
            >
              La plateforme tout-en-un pour gÃƒÂ©rer les examens, les notes et les rÃƒÂ©sultats des ÃƒÂ©coles privÃƒÂ©es du BÃƒÂ©nin.
            ...
            >
              ...
              >
                ...
                <span>Consulter les rÃƒÂ©sultats</span>
              </Link>
            </motion.div>
            ...
            >
              <div className="flex items-center space-x-2 px-3 py-1.5 bg-white/5 rounded-full">
                ...
                <span>SÃƒÂ©curitÃƒÂ© maximale</span>
              </div>
              <div className="flex items-center space-x-2 px-3 py-1.5 bg-white/5 rounded-full">
          ...
          >
            {[
              { value: "200+", label: "Ãƒâ€°coles", icon: <School className="w-6 h-6 text-yellow-400" /> },
              { value: "50K+", label: "Ãƒâ€°lÃƒÂ¨ves", icon: <Users className="w-6 h-6 text-blue-400" /> },
              { value: "99.9%", label: "DisponibilitÃƒÂ©", icon: <Clock className="w-6 h-6 text-green-400" /> },
          ...
          >
            <button className="animate-bounce text-white/60 hover:text-white transition-colors">
              ...
              <span className="block text-xs mt-1">DÃƒÂ©couvrir plus</span>
            </button>
          </motion.div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          ...
          >
            ...
            <p className="text-xl text-green-100/80 max-w-2xl mx-auto">
              AccÃ©dez Ã  un espace personnalisÃ© conÃ§u spÃ©cifiquement pour vos besoins
            </p>
          </motion.div>
            ...
            <div className="p-8 flex-1 flex flex-col">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600 mb-6">
                  Gestion rÃƒÂ©gionale des ÃƒÂ©coles privÃƒÂ©es et supervision des examens
                </p>
              </div>
              
              <div className="space-y-4 mb-8 flex-1">
                {[
                  "Gestion des ÃƒÂ©coles affiliÃƒÂ©es",
                  "Supervision des examens",
                  "Analytics rÃƒÂ©gionales",
                  "Rapports consolidÃƒÂ©s",
                  "Suivi des performances",
                  "Tableaux de bord personnalisÃƒÂ©s"
                ].map((feature, i) => (
          ...
          >
            ...
            <div className="p-8 flex-1 flex flex-col">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600 mb-6">
                  Gestion complÃƒÂ¨te de votre ÃƒÂ©tablissement scolaire
                </p>
              </div>
              
              <div className="space-y-4 mb-8 flex-1">
                {[
                  "CrÃƒÂ©ation et gestion d'examens",
                  "Saisie et validation des notes",
                  "Gestion des ÃƒÂ©lÃƒÂ¨ves et classes",
                  "Publication des rÃƒÂ©sultats",
                  "Bulletins personnalisÃƒÂ©s",
                  "Communication parents-ÃƒÂ©cole"
                ].map((feature, i) => (
                  <div key={i} className="flex items-start space-x-3">
                    <CheckCircle className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-600">{feature}</span>
              ...
              <div className="space-y-3 mt-auto">
                ...
                <div className="text-xs text-center text-gray-500 px-4">
                  Identifiants fournis par votre patronat rÃƒÂ©gional
                </div>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="p-8 flex-1 flex flex-col">
              <div className="text-center mb-8">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-3">
                  Consultation RÃƒÂ©sultats
                </h3>
                <p className="text-gray-600 mb-6">
                  AccÃƒÂ¨s aux rÃƒÂ©sultats en temps rÃƒÂ©el pour ÃƒÂ©lÃƒÂ¨ves et parents
                </p>
              </div>
              ...
              <div className="space-y-4 mb-8 flex-1">
                {[
                  ...
                  "Bulletins en ligne dÃƒÂ©taillÃƒÂ©s",
                  "Historique complet des notes",
                  "TÃƒÂ©lÃƒÂ©chargement PDF des relevÃƒÂ©s",
                  "Notifications des nouveaux rÃƒÂ©sultats",
              ...
              <div className="space-y-3 mt-auto">
                ...
                <div className="text-xs text-center text-gray-500">
                  AccÃƒÂ¨s sÃƒÂ©curisÃƒÂ© avec matricule ÃƒÂ©lÃƒÂ¨ve
                </div>
              </div>
            </div>
          </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-green-100/80 max-w-3xl mx-auto">
              Une plateforme complÃƒÂ¨te pour la gestion scolaire, conÃƒÂ§ue pour rÃƒÂ©pondre ÃƒÂ  tous vos besoins ÃƒÂ©ducatifs
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                title: "SÃƒÂ©curisÃƒÂ©",
                description: "DonnÃƒÂ©es chiffrÃƒÂ©es et isolation complÃƒÂ¨te entre les ÃƒÂ©tablissements"
              },
              {
                icon: <FileText className="w-8 h-8 text-white" />,
                title: "Conforme",
                description: "Interface et fonctionnalitÃƒÂ©s adaptÃƒÂ©es aux exigences ÃƒÂ©ducatives"
              },
              {
                icon: <Zap className="w-8 h-8 text-white" />,
                title: "Performant",
                description: "Plateforme rapide et fiable pour tous vos besoins ÃƒÂ©ducatifs"
              }
            ].map((feature, index) => (
              <motion.div 
                key={index}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center">
            <p className="text-green-100 mb-2">
              Ã‚Â© 2024 EducMaster Academia Hub. Tous droits rÃƒÂ©servÃƒÂ©s.
            </p>
            <p className="text-sm text-green-200">
              Plateforme officielle pour les ÃƒÂ©coles privÃƒÂ©es du BÃƒÂ©nin
            </p>
          </div>
        </div>
      </footer>
